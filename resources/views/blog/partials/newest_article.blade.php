    ...
    @foreach($articles as $index=>$a)
        @if($index==0)
            <div class="mdl-card coffee-pic mdl-cell mdl-cell--8-col">
                <div class="mdl-card__media mdl-color-text--grey-50" style="background-image: url('{{$a->image}}');">
                    <h3><a href="entry.html">{{$a->title}}</a></h3>
                </div>
...
{{--<div class="mdl-card amazing mdl-cell mdl-cell--12-col">--}}
    {{--<div class="mdl-card__title mdl-color-text--grey-50">--}}
        {{--<h3 class="quote"><a href="entry.html">I couldn’t take any pictures but this was an amazing thing…</a>--}}
        {{--</h3>--}}
    {{--</div>--}}
    {{--<div class="mdl-card__supporting-text mdl-color-text--grey-600">--}}
        {{--Enim labore aliqua consequat ut quis ad occaecat aliquip incididunt. Sunt nulla eu enim irure enim--}}
        {{--nostrud aliqua consectetur ad consectetur sunt ullamco officia. Ex officia laborum et consequat duis.--}}
    {{--</div>--}}
    {{--<div class="mdl-card__supporting-text meta mdl-color-text--grey-600">--}}
        {{--<div class="minilogo"></div>--}}
        {{--<div>--}}
